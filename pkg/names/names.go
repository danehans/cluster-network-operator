...
// TRUSTED_CA_BUNDLE_CONFIGMAP_NAME is the name of the ConfigMap
// containing the combined user/system trust bundle.
const TRUSTED_CA_BUNDLE_CONFIGMAP_NAME = "trusted-ca-bundle"

// TRUSTED_CA_BUNDLE_CONFIGMAP_NS is the namespace that hosts the
// ADDL_TRUST_BUNDLE_CONFIGMAP and TRUSTED_CA_BUNDLE_CONFIGMAP_NAME
// ConfigMaps.
...
const SYSTEM_TRUST_BUNDLE = "/Users/daneyonhansen/tmp/test.pem"
...
func TrustedCABundleConfigMap() types.NamespacedName {
	return types.NamespacedName{
		...
		Name:      TRUSTED_CA_BUNDLE_CONFIGMAP_NAME,
	}
}
...
func AddlTrustBundleConfigMapNS() types.NamespacedName {
	return types.NamespacedName{
		Namespace: TRUSTED_CA_BUNDLE_CONFIGMAP_NS,
	}
}
