...
import (
	...
	_"github.com/openshift/cluster-network-operator/pkg/apply"
...
func (r *ReconcileProxyConfig) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	/*status, err := r.clusterProxyStatus(context.TODO(), proxyConfig, infraConfig, netConfig, clusterConfig)
	if err != nil {
		log.Printf("Could not generate proxy status: %v", err)
	...
	log.Printf("Successfully reconciled Proxy.config.openshift.io %s\n", request.Name)
	return reconcile.Result{}, nil
}
