...
// data key named "ca-bundle.crt" and the value of the key is
// one or more valid PEM encoded certificates, returning a
// []byte of the certificate data upon success.
